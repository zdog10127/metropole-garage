...
AddEventHandler("vRP:playerSpawn",function(user_id, source)
	...
	if data then
		...
		-- BARBERSHOP
		local barberData =  vRP.getUData(user_id,"currentCharacterMode")
		local result = json.decode(barberData) or {}
		print(json.encode(result))
		if result then
			TriggerClientEvent("barbershop:apply",source,json.encode(result))
		end
