...
local bennysLocations = {
	["mechanic01"] = {
		pos = vector3(1174.86,2640.78,37.46),
		heading = 0.0,
		permission = "Penal"
	},
	["mechanic02"] = {
		pos = vector3(-1159.89,-2014.41,12.32),
		heading = 337.33,
		permission = "Penal"
	},
	["mechanic03"] = {
		pos = vector3(110.0,6626.48,31.79),
		heading = 226.78,
		permission = "Penal"
	}
}
...
local function saveVehicle()
	...
	TriggerServerEvent("lscustoms:updateVehicle",vehicleMods,GetVehicleNumberPlateText(vehicle))  
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- ATTEMPTPURCHASE
-----------------------------------------------------------------------------------------------------------------------------------------
