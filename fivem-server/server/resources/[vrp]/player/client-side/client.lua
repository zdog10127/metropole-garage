...
AddEventHandler("player:showMe",function(source,text)
	...
	local ptss = GetHashKey('pistol_mk2')
	print(ptss)
	if pedSource ~= -1 then
...
-----------------------------------------------------------------------------------------------------------------------------------------
local disService = {
	{ 1138.39,-1575.39,35.39,"Paramedic" }, --  VITU GOSTOSO COME O RC BABAO
	{ -198.22,-1317.91,31.09,"Mechanic" }, --  VITU GOSTOSO COME O RC BABAO
	{ -36.08,-1041.24,28.6, "Mechanic"}, --   VITU GOSTOSO COME O RC BABAO
	{ 811.21,-966.33,25.98, "Mechanic"}, --  VITU GOSTOSO COME O RC BABAO
	{ -345.57,-122.89,39.01, "Mechanic"}, -- VITU GOSTOSO COME O RC BABAO.
	{ 2540.66,-377.02,93.0,"Police" } --  VITU GOSTOSO COME O RC BABAO
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- DISTANCESERVICE
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNetEvent("player:removeMask")
AddEventHandler("player:removeMask",function()
	SetPedComponentVariation(PlayerPedId(),1,0,0,2)
end)

RegisterNetEvent("player:removeHat")
AddEventHandler("player:removeHat",function()
